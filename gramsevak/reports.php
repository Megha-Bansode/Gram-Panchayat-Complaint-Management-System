 ...
 * - complaints (complaint_id, category_id, assigned_to, status, complaint_title, village_ward, submitted_at)
 * - categories (category_id, category_name)
 * - users (user_id, full_name, role_id)
 *
 * Allowed Status Values ONLY: 'pending', 'assigned', 'in_progress', 'resolved'
 */
$page_title = "Analytical Reports & Export Engine";
$active_page = "reports";
