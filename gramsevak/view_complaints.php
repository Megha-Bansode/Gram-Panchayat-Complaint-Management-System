...
<head>
    ...
    <title>View Complaints - Gram Panchayat Complaint Management System</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <header class="gpcms-header">
                <div class="header-left">
                    ...
                    <div class="header-app-title">
                        <h1 class="h5 mb-0 font-weight-bold">View & Filter Complaints Log</h1>
                        <span class="text-muted small">Comprehensive Directory of Gram Panchayat Complaints</span>
                    </div>
                </div>
