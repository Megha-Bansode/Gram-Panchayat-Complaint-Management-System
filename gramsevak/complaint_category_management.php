...
<head>
    ...
    <title>Category Management - Gram Panchayat Complaint Management System</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <aside class="gpcms-sidebar" id="gpcmsSidebar">
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="complaint_category_management.php" class="nav-link active">
            ...
            <header class="gpcms-header">
                <div class="header-left">
                    ...
                    <div class="header-app-title">
                        <h1 class="h5 mb-0 font-weight-bold">Complaint Category Management</h1>
                        <span class="text-muted small">Configure and maintain civic complaint classifications</span>
                    </div>
                </div>
