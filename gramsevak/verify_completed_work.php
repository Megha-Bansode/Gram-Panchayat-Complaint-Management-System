...
<head>
    ...
    <title>Verify Completed Work - Gram Panchayat Complaint Management System</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <aside class="gpcms-sidebar" id="gpcmsSidebar">
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="verify_completed_work.php" class="nav-link active">
            ...
            <header class="gpcms-header">
                <div class="header-left">
                    ...
                    <div class="header-app-title">
                        <h1 class="h5 mb-0 font-weight-bold">Work Verification & Quality Audit</h1>
                        <span class="text-muted small">Compare Before & After Photo Evidence Submitted by Field Officers</span>
                    </div>
                </div>
