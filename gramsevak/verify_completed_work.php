            ...
            <header class="gpcms-header">
                <div class="header-left">
                    ...
                    <div class="header-app-title">
                        <h1 class="h5 mb-0 font-weight-bold">Work Verification & Closure Portal</h1>
                        <span class="text-muted small">Inspect Field Officer Evidence & Sign-off Resolution</span>
                    </div>
                </div>
