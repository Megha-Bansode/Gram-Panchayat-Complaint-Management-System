            ...
            <header class="gpcms-header">
                <div class="header-left">
                    ...
                    <div class="header-app-title">
                        <h1 class="h5 mb-0 font-weight-bold">Complaint Lifecycle & Status Update</h1>
                        <span class="text-muted small">Update official complaint progress using allowed contract statuses</span>
                    </div>
                </div>
