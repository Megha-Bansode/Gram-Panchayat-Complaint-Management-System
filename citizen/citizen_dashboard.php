...
/**
 * Returns a human-readable label for a complaint status value.
 *
 * @param string $status  One of: pending, assigned, in_progress, resolved
 * @return string
 */
                        ...
                        <div class="table-responsive">
                            <table class="citizen-table w-100" id="recentComplaintsTable"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="citizen-status-badge <?php echo get_status_badge_class($cmp['status']); ?>">
                                            <?php echo get_status_label($cmp['status']); ?>
                                        </span>
                                    </td>
                                    <td>
